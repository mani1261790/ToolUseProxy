...
`Stage`はTrace / Detect / Stopという研究上の由来を示します。複数Stageを横断するpackage、配布、導入UXは無理にStageを追加せず、`productization`ラベルとrelease milestoneで管理します。現在のrelease横断作業は[`v0.1.0 Public Alpha`](https://github.com/mani1261790/ToolUseProxy/milestone/1)です。
