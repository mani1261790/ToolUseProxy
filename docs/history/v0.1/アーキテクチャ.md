...
redactionはpreview、hash-only audit、将来renderer向けのdormant linkageとPost confirmationまでを保持します。複数Hook rewriteの最終採用inputを証明できるexclusive enforcement境界が成立するまで、runtime rewriteは有効にしません。詳細は[Redact](../../設計/Redact.md)を参照してください。

## 詳細設計

- Hook payload、設定、保存範囲: [Hook設定](../../設定/Hook設定.md)
- graph、source binding、lineage、再解析: [情報流追跡](../../設計/情報流追跡.md)
- tool固有のstructured edge: [アダプター](../../設計/アダプター.md)
- graph上の出口: [外部流出候補](../../設計/外部流出候補.md)
- findingと経路再構築: [漏えい検知](../../設計/漏えい検知.md)
- policy actionとCodex Hook出力: [Policy判断](../../設計/Policy判断.md)
- lineage tree、Mermaid、DOT、JSON: [可視化](../../設計/可視化.md)
