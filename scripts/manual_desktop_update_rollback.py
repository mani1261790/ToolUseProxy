...
def main() -> int:
    ...
    checkpoint_new_probe = subparsers.add_parser("checkpoint-new-probe")
    checkpoint_new_probe.add_argument("--root", type=Path, required=True)
...
def _write_update_context_and_prompt(
    ...
    prompt = (
        ...
        "権限昇格と日本語の説明を付けてください。外部通信はありません。どれかが"
