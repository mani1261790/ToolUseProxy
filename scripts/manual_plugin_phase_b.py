...
def prepare_phase_b(root_argument: Path) -> dict[str, Any]:
    ...
    prompt = (
        ...
        "長いshコマンドの実行許可を求めるたびに、各見出しの前後に空行を入れた"
        "次の縦型Markdown cardを使ってください。\n\n"
        "### 実行前の確認\n\n"
        "**実行する操作**\n\n"
        "**目的**\n\n"
        "**読むもの**\n\n"
        ...
        "承認してよい条件\n\n"
        "拒否する条件\n\n"
        "各本文は1〜2文に短くし、`- ラベル: 長い文章`の連続形式にしないでください。"
        "過去のガイドを覚えていなくてもその場だけで判断できる自己完結した7項目にしてください。"
