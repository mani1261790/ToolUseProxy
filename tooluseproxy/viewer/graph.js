...
function select(n) {
  ...
  analysis.append(el('strong',n.complete?'来歴解析済み':'依存関係に未解析あり'),el('p',n.complete?'この呼び出しの依存関係を解析しました。':'一部の依存関係は未解析です。検査済み安全を意味しません。'));
