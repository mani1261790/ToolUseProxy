...
- moving marketplace refによるalpha.1からalpha.6へのnative upgrade、immutable alpha.1からalpha.6へのlifecycle upgrade、backupを使うsafe rollback、Plugin / marketplace remove、data保持 / 明示uninstallはisolated Codex CLIで検証済み。Linux実Codex CLI、Windows実機、将来version間の反復は未完了
